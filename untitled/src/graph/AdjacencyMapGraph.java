...
public class AdjacencyMapGraph<V, E> implements Graph<V, E> {
   ...
   */
    public Map<Vertex<V>, Edge<E>> DFSComplete(Graph<V, E> graph) {
    ...
    public void DFS(Graph<V, E> graph, Vertex<V> u, Set<Vertex<V>> known, Map<Vertex<V>, Edge<E>> forest) {
        // u has been discovered
        known.add(u);
        // for every outgoing edge from u
        for (Edge<E> edge : graph.outgoingEdges(u)) {
            Vertex<V> vertex = graph.opposite(u, edge);
            if (!known.contains(vertex)) {
    ...
    public void BFS(Graph<V, E> graph, Vertex<V> u, Set<Vertex<V>> known, Map<Vertex<V>, Edge<E>> forest) {
        ...
        while (!level.isEmpty()) {
            ...
            for (Vertex<V> vertex : level) {
                for (Edge<E> edge : graph.outgoingEdges(vertex)) {
                    Vertex<V> v = graph.opposite(vertex, edge);
                    if (!known.contains(v)) {
                        known.add(v);
    ...
    public PositionalList<Edge<E>> constructPath(Graph<V, E> graph, Vertex<V> u, Vertex<V> v, Map<Vertex<V>, Edge<E>> forest) {
